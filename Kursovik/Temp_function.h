...
void print_yearstat_info(data *dt_source, data_month *dt_dest);  // Добавляем прототип
void process_file_and_show_stats(char *filename, uint8_t month); // Новая функция
#endif